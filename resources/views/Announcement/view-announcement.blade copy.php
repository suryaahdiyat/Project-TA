        ...
        <div id="carouselTrack" class="flex transition-transform duration-700 ease-in-out">
            @foreach ($announcements as $index => $announcement)
                ...
                <div class="relative min-w-full px-12 py-20 text-justify text-dark">
                    ...
                    <div class="absolute top-0 bottom-0 left-0 right-0 w-full h-screen bg-black/60 -z-40"></div>
                    <div class="flex flex-col items-center justify-center text-primary">
                        <div class="flex items-start justify-around w-1/2">
                            <div>
                                <div class="relative inline-flex items-center justify-center w-[330px] h-[330px]"
                                    ...
                                    <img src="{{ asset('/storage/' . $couple->groom_photo) }}"
                                        class="relative z-10 object-cover w-[200px] h-[300px] rounded-full"
                                        alt="Foto Suami">
                            ...
                            <span class="self-center text-pink-500 text-8xl font-wedding">&</span>
                            <div>
                                <div class="relative inline-flex items-center justify-center w-[330px] h-[330px]"
                                    style="overflow: visible;">
                ...
                <div class="relative min-w-full px-12 py-20 text-justify text-dark">
                            ...
                            <div class="flex items-start justify-around w-1/2">
                                <div>
                                    <div class="relative inline-flex items-center justify-center w-[330px] h-[330px]"
                                        style="overflow: visible;">
                                        <img src="{{ asset('/storage/' . $couple->groom_photo) }}"
                                            class="relative z-10 object-cover w-[170px] h-[270px] rounded-full"
                                            alt="Foto Suami">
                    ...
                    <div class="flex items-start justify-center gap-5 text-sm text-primary">
                        <div
