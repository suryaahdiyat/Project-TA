{{-- <h2>Jadwal Pernikahan Anda Telah Dijadwalkan</h2>

<p><strong>Tanggal:</strong> {{ \Carbon\Carbon::parse($schedule->marriage_date)->format('d M Y') }}</p>
<p><strong>Waktu:</strong> {{ \Carbon\Carbon::parse($schedule->marriage_time)->format('H:i') }}</p>
<p><strong>Tempat:</strong> {{ $schedule->marriage_venue }}</p>

<p>Silakan hadir tepat waktu. Terima kasih.</p> --}}
...
<body style="font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 20px;">
    <div
        ...
        <h2 style="color: #2d3748; text-align: center;">🎉 Jadwal Pernikahan Telah Dijadwalkan 🎉</h2>

        <p style="font-size: 16px; color: #4a5568;">Selamat! Berikut adalah detail jadwal pernikahan Anda:</p>
